...
df_inf=pd.read_csv(r"D:\Programming Files\PycharmProjects\PCOS\PCOS_infertility.csv")
df_noinf=pd.read_excel(r"D:\Programming Files\PycharmProjects\PCOS\PCOS_data_without_infertility (5).xlsx",sheet_name="Full_new")
